          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-togle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Login <span class="caret"></span></a>
  ...
  <ul class="Carousel">
    ...
    <li class="Items Front">
      <div class="item">
		...
		<p> Trending Track </p>
    <li class="Items Left">
	        <img src="http://hoodtapes.co.uk/wp-content/uploads/2016/09/Front-271x300.png" alt="Nature" style="width:100%"></li>
		<p> Trending Videos </p>
    <li class="Items Left2">
<img src="http://thefader-res.cloudinary.com/images/w_1440,c_limit,f_auto,q_auto:best/Nines_One_Foot_Out_q4wnev/nines-one-foot-out-review-xl-recordings.jpg" alt="Fjords" style="width:100%"></li>
    <li class="Items Right">
	<img src="http://s3.amazonaws.com/factmag-images/wp-content/uploads/2017/04/C8g31YyXsAAPKZd.jpg"" alt="Lights" style="width:100%"></li>
